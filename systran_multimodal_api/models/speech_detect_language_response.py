...
class SpeechDetectLanguageResponse(object):
    """
    ...
    def __init__(self):
        ...
        self.systran_types = {
            ...
            'speakers': 'list[SpeechLangSpeaker]',
            'segments': 'list[SpeechLangSegment]'
        }
        ...
        # Array of speakers
        self.speakers = None  # list[SpeechLangSpeaker]
        
        # Array of segments
        self.segments = None  # list[SpeechLangSegment]
