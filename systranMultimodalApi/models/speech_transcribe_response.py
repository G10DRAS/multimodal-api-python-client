...
class SpeechTranscribeResponse(object):
    """
    ...
    def __init__(self):
        ...
        self.systran_types = {
            ...
            'speakers': 'list[SpeechTranscribeSpeaker]',
            'segments': 'list[SpeechTranscribeSegment]'
        }
        ...
        # Array of speakers
        self.speakers = None  # list[SpeechTranscribeSpeaker]
        
        # Array of segments
        self.segments = None  # list[SpeechTranscribeSegment]
